...
3) Access the `workbench` named `test-tls-update-feb19-1-notebook`.
...
5) In the terminal, run `cd test-tls-update-feb19-1` to navigate to your sample app's directory.
